    ...
    <Card className="border-cyan-200 bg-cyan-50/50">
      <CardContent className="p-4">
        ...
        <div className="space-y-2">
          {invites.map(invite => (
            <div key={invite.id} className="flex items-center justify-between bg-white rounded-lg border border-gray-200 p-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">{invite.companyName}</p>
              ...
              <Button
                ...
                className="gap-1.5 bg-cyan-800 text-white hover:bg-cyan-900 cursor-pointer"
              >
