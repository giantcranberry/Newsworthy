  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <Button data-tour="categories-add" onClick={handleCreate} className="gap-2 bg-cyan-800 dark:bg-cyan-600 text-white dark:text-white hover:bg-cyan-900 dark:hover:bg-cyan-700 cursor-pointer">
