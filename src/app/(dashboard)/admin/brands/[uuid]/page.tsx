  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <Link href="/admin/brands" className="inline-flex items-center text-sm text-gray-600 hover:text-gray-900 gap-1">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Brand ID: {brand.id}</p>
            </div>
          </div>
          {!brand.isDeleted && (
            <Link href={`/company/${brand.uuid}`}>
              <Button className="gap-2 bg-cyan-800 hover:bg-cyan-900 text-white">
        ...
        <Card>
          ...
          <CardContent className="space-y-5">
              ...
              <div className="space-y-3 border-t pt-4">
                ...
                {brand.email && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-900">{brand.email}</span>
                  </div>
                )}
                {brand.phone && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-900">{brand.phone}</span>
                  </div>
                )}
              </div>
            )}
            ...
            {(brand.nrUri || brand.linkedinUrl || brand.xUrl) && (
              <div className="space-y-3 border-t pt-4">
                <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">Online Presence</p>
                {brand.nrUri && (
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-700">Newsroom URI</span>
                    <span className="text-sm font-mono text-gray-900">{brand.nrUri}</span>
                  </div>
                )}
                {brand.linkedinUrl && (
                  <div className="flex items-center justify-between">
          ...
          <Card>
            ...
            <CardContent>
              {brandReleases.length > 0 ? (
                ...
                <p className="text-sm text-gray-500 text-center py-4">No releases</p>
              )}
            </CardContent>
          </Card>
        </div>
