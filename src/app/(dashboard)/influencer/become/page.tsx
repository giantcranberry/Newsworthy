...
export default async function BecomeInfluencerPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Become an Influencer</h1>
        <p className="text-gray-500 dark:text-gray-400">Join our marketplace and monetize your social reach</p>
      </div>
