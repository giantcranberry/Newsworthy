        ...
        {messages.length > 0 && (
          <div className="flex items-center gap-2">
            {(() => {
              ...
              return (
                <>
                  <UserAvatar name={otherMsg.userName} avatar={otherMsg.userAvatar} emailHash={otherMsg.userEmailHash} size="sm" />
        ...
        {loading ? (
          ...
          messages.map((msg, idx) => {
            ...
            return (
              ...
              >
                {!isOwn && showAvatar && (
                  <UserAvatar name={msg.userName} avatar={msg.userAvatar} emailHash={msg.userEmailHash} size="sm" />
                )}
