        ...
        <div className="w-full sm:max-w-md sm:bg-white dark:bg-gray-900 sm:rounded-2xl sm:shadow-xl sm:border sm:border-slate-200 dark:border-gray-800 sm:p-8">
          ...
          {errorParam && (
            <div className="mb-4 p-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-lg text-red-700 dark:text-red-400 text-sm">
              ...
              {errorParam === 'company_email_required' &&
              ...
              {!['expired_link', 'invalid_link', 'server_error', 'company_email_required', 'AccessDenied', 'OAuthCallback', 'OAuthAccountNotLinked'].includes(
                errorParam
            ...
            <>
              ...
              {activeTab === 'password' ? (
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="text-sm font-medium text-cyan-800 dark:text-cyan-400 hover:text-cyan-900 dark:hover:text-cyan-300"
                      >
                        Forgot password?
                      </Link>
                    </div>
                ...
                <form onSubmit={handleMagicLink} className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="magic-email" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      Email Address
                    </Label>
                    <div className="relative">
                      <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 sm:h-4 sm:w-4 text-gray-400" />
              ...
              <p className="mt-8 sm:mt-6 text-center text-base sm:text-sm text-gray-500 dark:text-gray-400">
                ...
                <Link href="/register" className="font-semibold text-cyan-800 dark:text-cyan-400 hover:text-cyan-800 dark:text-cyan-400">
                  Sign up
                </Link>
              </p>
            </>
