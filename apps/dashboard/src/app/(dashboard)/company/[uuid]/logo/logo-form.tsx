      ...
      <CardContent>
        {readOnly ? (
          logoUrl ? (
            ...
            <div className="h-32 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 flex items-center justify-center">
              ...
              {isUploadingLogo ? (
                ...
                <>
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 rounded-xl transition-colors flex items-center justify-center">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-gray-900/90 backdrop-blur-sm rounded-lg px-3 py-2 shadow-sm dark:shadow-gray-900/50">
                      <p className="text-xs font-medium text-gray-700 dark:text-gray-300">Click to replace</p>
                    </div>
                  </div>
                  {/* Remove button */}
                  <button
                    ...
                    className="absolute top-2 right-2 p-1.5 rounded-full bg-white dark:bg-gray-900/90 hover:bg-red-50 border border-gray-200 dark:border-gray-800 hover:border-red-300 text-gray-500 dark:text-gray-400 hover:text-red-600 dark:text-red-400 shadow-sm dark:shadow-gray-900/50 opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <div className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 group-hover:bg-cyan-800/10 dark:bg-cyan-400/10 flex items-center justify-center mb-2 transition-colors">
