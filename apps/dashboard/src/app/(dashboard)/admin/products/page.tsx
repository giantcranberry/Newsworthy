...
export default async function AdminProductsPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Upgrade Products</h1>
        <p className="text-gray-600 dark:text-gray-400">Manage press release upgrade products</p>
      </div>
