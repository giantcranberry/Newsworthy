...
export function InvoiceUserDialog({
  ...
  const resetForm = () => {
    ...
    setCredits('0')
    setCreditType('none')
    setCompanyId(userBrands.length === 1 ? String(userBrands[0].id) : '')
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Invoice {userName || userEmail}</DialogTitle>
            <DialogDescription>
          ...
          {resultUrl ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Shown as the memo on the Stripe invoice (above the line items). Optional for simple invoices; use it for client lists and ad-hoc detail.
                </p>
              </div>
              ...
              <fieldset className="rounded-md border border-gray-200 dark:border-gray-800 p-3 space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Choose None for consulting, writing, or other ad-hoc work. Payment is still recorded when paid.
                  </p>
                </div>
