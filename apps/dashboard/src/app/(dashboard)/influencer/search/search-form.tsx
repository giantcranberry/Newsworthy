        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm dark:shadow-gray-900/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
