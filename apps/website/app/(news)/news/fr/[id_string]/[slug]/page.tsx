...
export default async function FrenchPR({ params }: Props) {
  ...
  return (
    <div
      className="w-full md:max-w-4xl lg:max-w-5xl xl:max-w-screen-2xl lg:mx-auto grid grid-cols-1 lg:grid-flow-col gap-10 px-5 md:px-10 lg:px-0 mb-5 lg:my-10 xl:px-20"
      key={currentPr.prId}
    >
      <div className="col-span-2 flex flex-col items gap-5">
        <div className="flex justify-between lg:items-end pt-3">
          <div className="flex gap-5">
            {es_link && (
              <Link className="text-sky-600 hover:underline" href={es_link}>
      ...
      <div className="col-span-2 md:col-span-1 lg:col-span-1">
        <div className="lg:max-w-[350px] w-full flex flex-col md:flex-row items-start flex-wrap lg:flex-col gap-5">
          ...
          <div>
            ...
            {pr.company.nrUri && (
              <div className="mt-3">
                ...
                >
                  Salle de Presse en Ligne <ExternalLink size={16} />
                </Link>
              </div>
            )}
          </div>
