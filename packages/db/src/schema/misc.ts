...
export const aiJobs = pgTable('ai_jobs', {
  ...
  uuid: varchar('uuid', { length: 32 }).unique().notNull(),
  tweet1: text('tweet1'),
  tweet2: text('tweet2'),
  tweet3: text('tweet3'),
  post: text('post'),
  ...
  headlinePhonetic: text('headline_phonetic'),
  ltiCreated: boolean('lti_created'),
  ytCreated: boolean('yt_created'),
  ltiPhonetic: text('lti_phonetic'),
  ytPhonetic: text('yt_phonetic'),
...
export const aiVideos = pgTable('ai_videos', {
  ...
  prId: integer('pr_id'),
  uuid: varchar('uuid', { length: 32 }).unique().notNull(),
  shortsMp3: varchar('shorts_mp3', { length: 255 }),
  shortsMp4: varchar('shorts_mp4', { length: 255 }),
  shortsVoice: varchar('shorts_voice', { length: 25 }),
  hitcount: integer('hitcount'),
  createdAt: timestamp('created_at'),
  isDeleted: boolean('is_deleted'),
  shortImg: varchar('short_img', { length: 255 }),
  squareImg: varchar('square_img', { length: 255 }),
  shortsS3: varchar('shorts_s3', { length: 255 }),
  audCreatedAt: timestamp('aud_created_at'),
  vidCreatedAt: timestamp('vid_created_at'),
  ltiMp4S3: text('lti_mp4_s3'),
  shortsMp4S3: text('shorts_mp4_s3'),
  ltiMp4: varchar('lti_mp4', { length: 255 }),
  aprMp3: text('apr_mp3'),
  aprS3: text('apr_s3'),
